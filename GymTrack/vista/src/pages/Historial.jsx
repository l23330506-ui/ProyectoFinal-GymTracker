  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', fontFamily: 'sans-serif' }}>
      <div style={{ background: '#fff', padding: '25px', borderRadius: '12px', border: '1px solid #e5e7eb', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
        ...
        <p style={{ color: '#666', margin: '0 0 25px 0' }}>Línea de tiempo alimentada en tiempo real al finalizar tus sesiones.</p>
          ...
          {registros.map((item, index) => (
            <div key={index} style={{ borderLeft: '4px solid #dc2626', paddingLeft: '15px', margin: '5px 0' }}>
              ...
              <p style={{ margin: '0', color: '#4b5563', fontSize: '0.9rem' }}>
                ⏱️ Duración: {item.duracion} | 💪 {item.seriesTotales} Series hechas | <span style={{ color: '#059669', fontWeight: '500' }}>{item.estado}</span>
              </p>
            </div>
          ))}
        </div>
